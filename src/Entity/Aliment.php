...
class Aliment
{
     ...
     * @Assert\Length(min=3,max=15, minMessage="Le nom doit faire 3 carctères minimum", maxMessage="Le nom doit faire moins de 15 caractères")
     */
    private $nom;

    /**
     * @ORM\Column(type="float")
     * @Assert\Range(min=0.1, max=100, notInRangeMessage = "Le prix doit être compris enter 0.1 et 100 euros")
     */
    private $prix;
