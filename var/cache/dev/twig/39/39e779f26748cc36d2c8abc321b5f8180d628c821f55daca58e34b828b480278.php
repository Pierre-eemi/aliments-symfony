...
";
    ...
    {
        return array (  196 => 34,  178 => 33,  160 => 32,  142 => 6,  123 => 5,  108 => 35,  105 => 34,  103 => 33,  99 => 32,  90 => 26,  85 => 24,  70 => 12,  63 => 8,  60 => 7,  58 => 6,  54 => 5,  48 => 1,);
    }
...
<html>
    ...
    <body>
        <nav class=\"navbar navbar-expand-lg navbar-dark bg-primary\">
            <a class=\"navbar-brand\" href=\"{{path('aliments')}}\">TaRecette.com</a>
            <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarColor01\" aria-controls=\"navbarColor01\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">
              <span class=\"navbar-toggler-icon\"></span>
            </button>
            ...
            <div class=\"collapse navbar-collapse\" id=\"navbarColor01\">
              <ul class=\"navbar-nav mr-auto\">
                <li class=\"nav-item dropdown\">
                  ...
                  <div class=\"dropdown-menu\" aria-labelledby=\"navbarDropdown\">
                    <a class=\"dropdown-item\" href=\"{{path('aliments')}}\">Aliments</a>
                    <div class=\"dropdown-divider\"></div>
                    <a class=\"dropdown-item\" href=\"{{path('admin_aliment')}}\">Administration</a>
                  </div>
                </li>
              </ul>
            </div>
          </nav>
        <h1 class=\"border border-primary rounded p-2 m-2 text-white bg-info\">{% block monTitre %}{% endblock %}</h1>
        {% block body %}{% endblock %}
...
", "base.html.twig", "/Users/macbook/Desktop/Realisations/3-recette/templates/base.html.twig");
    }
}
